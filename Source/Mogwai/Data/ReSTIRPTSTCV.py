...
if arguments.only_GI:
    dict['PT']={'samplesPerPixel': 1,'CVMode':ReSTIRCVMode.STCV, 'useDirectLighting': False}
else:
    dict['PT']={'samplesPerPixel': 1,'CVMode':ReSTIRCVMode.STCV}
dict['DI']={'CVMode':CVMode.STCV}
