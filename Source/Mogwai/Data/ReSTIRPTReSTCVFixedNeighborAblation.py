...
dict['PT']={'samplesPerPixel': 1,'CVMode':ReSTIRCVMode.ReSTCV,'spatialReusePattern': SpatialReusePattern.SmallWindow,'spatialNeighborCount':4}
dict['DI']={'CVMode':CVMode.Enable}

methodName="restcv_fixed_neighbor_ablation"
