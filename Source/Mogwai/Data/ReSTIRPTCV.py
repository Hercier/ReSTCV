...
if arguments.only_GI:
    dict['PT']={'samplesPerPixel': 1,'CVMode':ReSTIRCVMode.ReSTCV, 'spatialNeighborCount':4, 'useDirectLighting': False}
else:
    dict['PT']={'samplesPerPixel': 1,'CVMode':ReSTIRCVMode.ReSTCV}
